...
local function run_screenshot(arguments)
	return function()
		hl.dispatch(hl.dsp.exec_cmd(screenshot_cmd .. arguments))
...
hl.bind("SUPER + SHIFT + S", submap.switch("screenshot"))
...
hl.define_submap("screenshot", function()
	...
	hl.bind("F", hl.dsp.submap("screenshot_fullscreen"))

	hl.bind("A", hl.dsp.submap("screenshot_area"))
...
hl.define_submap("screenshot_fullscreen", function()
	-- 1: Copy and save.
	hl.bind("1", run_screenshot(""))

	-- 2: Edit, copy and save.
	hl.bind("2", run_screenshot(" --edit"))

	-- 3: Copy without saving.
	hl.bind("3", run_screenshot(" --no-save"))

	-- 4: Edit and copy without saving.
	hl.bind("4", run_screenshot(" --edit --no-save"))

	-- 5: Save without copying.
	hl.bind("5", run_screenshot(" --no-copy"))

	-- 6: Edit and save without copying.
	hl.bind("6", run_screenshot(" --edit --no-copy"))
...
hl.define_submap("screenshot_area", function()
	...
	hl.bind("1", run_screenshot(" --area"))

	-- 2: Select area, edit, copy and save.
	hl.bind("2", run_screenshot(" --area --edit"))

	-- 3: Select area and copy without saving.
	hl.bind("3", run_screenshot(" --area --no-save"))

	-- 4: Select area, edit and copy without saving.
	hl.bind("4", run_screenshot(" --area --edit --no-save"))

	-- 5: Select area and save without copying.
	hl.bind("5", run_screenshot(" --area --no-copy"))

	-- 6: Select area, edit and save without copying.
	hl.bind("6", run_screenshot(" --area --edit --no-copy"))
