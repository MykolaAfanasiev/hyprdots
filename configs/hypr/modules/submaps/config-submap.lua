...
hl.define_submap("config_waybar", function()
	hl.bind("1", function()
		hl.dispatch(hl.dsp.exec_cmd(paths.waybar.clock .. " toggle"))

		hl.dispatch(hl.dsp.submap("reset"))
	end)
	hl.bind("r", function()
		hl.dispatch(hl.dsp.exec_cmd('pkill -x waybar; sleep 0.2; "' .. paths.waybar.launch .. '"'))

		hl.dispatch(hl.dsp.submap("reset"))
	end)

	hl.bind("escape", submap.switch("config"))

	hl.bind("SHIFT + escape", submap.switch("reset"))
end)
...
hl.define_submap("config_swaync", function()
	...
	hl.bind("d", function()
		hl.dispatch(hl.dsp.exec_cmd(paths.swaync.control .. " dnd"))
	...
	hl.bind("r", function()
		hl.dispatch(hl.dsp.exec_cmd(paths.swaync.control .. " reload"))
...
hl.define_submap("config_hyprpaper", function()
	hl.bind("r", function()
		hl.dispatch(hl.dsp.exec_cmd(paths.hyprpaper.control .. " restart"))
