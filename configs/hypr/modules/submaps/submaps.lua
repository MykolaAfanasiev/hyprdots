...
hl.bind(vars.mainMod .. " + CTRL + B", hl.dsp.exec_cmd(paths.bluetooth.launch))
...
hl.bind(vars.mainMod .. " + ALT + L", hl.dsp.exec_cmd(paths.hyprlock.launch))
