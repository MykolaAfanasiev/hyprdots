# NetworkManager Rofi theme

[Русская версия](README_networkmanager_ru.md) · [Configurations](../README_configs.md) · [Project](../../README.md)

## Purpose

Palette and Rofi styling used by the Wi-Fi frontend.
